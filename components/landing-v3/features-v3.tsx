      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            >
              <div className="overflow-hidden rounded-2xl border border-[#E2E8F0]/60 bg-white p-6 sm:p-8">
                <div className="mb-6">
                  <span className="inline-block rounded-full bg-[#F1F5F9] px-3 py-1 font-mono text-[10px] font-medium uppercase tracking-wider text-[#0F172A]">
                    Primary Cause
                  </span>
                </div>

                <p className="text-xl font-semibold leading-snug text-[#0F172A]">
                  Premature scaling with unproven unit economics
                </p>

                <div className="mb-6 mt-6 border-t border-[#E2E8F0]/60 pt-6">
                  <p className="font-mono text-[10px] font-medium uppercase tracking-[0.1em] text-[#64748B]">
                    What Would Have Saved It
                  </p>
                  <ul className="mt-3 flex flex-col gap-2">
                    <li className="flex items-start gap-2 text-sm text-[#0F172A]">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 flex-shrink-0 text-[#FD6703]" />
                ...
                <div className="mb-6 border-t border-[#E2E8F0]/60 pt-6">
                  <p className="font-mono text-[10px] font-medium uppercase tracking-[0.1em] text-[#64748B]">
                ...
                <div className="h-px w-full bg-[#E2E8F0]/60" />
                <p className="mt-4 font-mono text-[10px] font-medium uppercase tracking-[0.15em] text-[#94A3B8]">
          ...
          <div className="flex flex-col gap-6">
            {[
              ...
              >
                <div className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#EAE2F8] to-[#F3E8FF]">
                  <CheckCircle2 className="h-4 w-4 text-[#FD6703]" />
                </div>
                <div>
