      ...
      >
        <div className="flex items-center gap-3">
          <span className="relative flex h-2.5 w-2.5">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#D62828] opacity-75" />
            <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[#D62828]" />
          </span>
          <h3 className="text-base font-medium text-[#F4F1EA]">
            ...
            {deep && (
              <span className="ml-2 rounded-full bg-[#D62828]/10 px-2 py-0.5 text-[10px] font-medium text-[#D62828]">
                Deep mode
              </span>
            )}
          </h3>
        ...
        {onCancel && (
          <button
            onClick={onCancel}
            className="inline-flex h-8 items-center gap-1.5 rounded-md border border-[#D62828]/30 px-3 text-[10px] font-medium text-[#D62828] transition-colors hover:bg-[#D62828]/10"
          >
